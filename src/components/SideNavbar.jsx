...
function SideNavBar(prop) {
    ...
    const sideBarSection = "flex flex-col gap-1 border-b-[1px] border-gray-300 pb-[10px] pt-[10px]";
    ...
    return (
        <div className={`h-[92vh] flex flex-col overflow-hidden bg-white hover:overflow-y-auto scroll-width hover:scroll-auto fixed top-[60px] left-0 transition-all duration-300 z-20 
            ${prop.isOpen ? "w-[180px] pl-4 sm:w-[275px]" : "w-[45px] sm:w-[60px] ml-2 sm:ml-5"}`}>
            ...
            {/* Sidebar - Middle */}
            <div className={sideBarSection}>
                <span className={prop.isOpen ? "px-[9px] py-[7px] text-[12px] sm:text-[16px]" : "hidden"}>{`You >`}</span>
